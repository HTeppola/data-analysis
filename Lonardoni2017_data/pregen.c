...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 SpikeGenerator C:/Users/teppola/Documents/OCNC_Project/Heidis_modeling_project_OCNC/data-analysis/Lonardoni2017_data/pregen.mod\n");
...
double interval (  double _lmean ) {
 ...
 if ( _lmean <= 0. ) {
   ...
   if ( noise  == 0.0 ) {
     ...
     _linterval = ( 1. - noise ) * _lmean + noise * ( _lmean * exprand ( 1.0 ) + delay ) ;
     }
