...
cellRule['secs']['soma']['geom'] = {'diam': 10.0, 'cm': 1}  # soma geometry
cellRule['secs']['soma']['pointps']['Izhi'] = {'mod':'AdExp', 'vref':'vv', 'tau_w': 300, 'G_l': 12, 'a': 2, 'b': 60, 
        'C': 281, 'E_l': -70, 'V_thre': -50, 'Delta_T': 2, 'V_reset': -58, 'iEXT': 175} 					# soma hh mechanisms
netParams.cellParams['PYR_Izhi_rule'] = cellRule  		
...
netParams.stimSourceParams['bkg'] = {'type': 'NetStim', 'rate': 3000, 'noise': 1} #changed rate from 100 to 3000 and noise from 0.5 to 1
...
simConfig.analysis['plotTraces'] = {'include': [30]} 	# Plot recorded traces for this list of cells
